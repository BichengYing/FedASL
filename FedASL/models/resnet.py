...
class BasicBlockCifar10(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option="A"):
        ...
        self.bn1 = lambda x: x  # nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2 = lambda x: x  # nn.BatchNorm2d(planes)
...
class BottleneckCifar10(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn2 = lambda x: x  # nn.BatchNorm2d(planes)
        self.conv3 = nn.Conv2d(planes, self.expansion * planes, kernel_size=1, bias=False)
        self.bn3 = lambda x: x  # nn.BatchNorm2d(self.expansion * planes)
...
class ResNetCifar10(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, model_name="ResNetCifar10"):
        ...
        self.bn1 = lambda x: x  # nn.BatchNorm2d(16)
